...
def get_function_sequence(note_sequence):
    ...
    for i, note in enumerate(note_sequence):
        ...
        if note["note"] == 'transition':
            ...
            # bow_direction = not bow_direction
            res += function + f"({int(bow_direction)}, {note_duration})\n  stay()\n  "
    return res



# load_scripts()
note_sequence = parse_midi("/Users/PV/Desktop/Robot Cello/residual/Robot-Cello-ResidualRL/MIDI-Files/twinkle_twinkle-open.mid")
print(note_sequence)
function_sequence = get_function_sequence(note_sequence)
# print(function_sequence)

f = open("/Users/PV/Desktop/Robot Cello/residual/Robot-Cello-ResidualRL/URScripts/test.script", "r")
script = f.read()
