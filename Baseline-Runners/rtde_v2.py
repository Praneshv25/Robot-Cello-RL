    ...
    def bow(bow_dir, note_dur, bow_poses):
        ...
        if dist_to_end >= target_dist:
            ...
            for i in range(500):
                ...
                rtde_c.servoL(tcp_pose, 0, 0, note_dur/500 , 0.1, 500)
...
"""
            ...
            for i in range(500):
                ...
                rtde_c.servoL(tcp_pose, 0, 0, note_dur/500.0 , 0.1, 500.0)
                tcp_pose += target_pose.tolist()/500.0
        ...
        """
            ...
            for i in range(500):
                ...
                rtde_c.servoL(tcp_pose, 0, 0, time_a/500 , 0.1, 500)
                tcp_pose += target_pose.tolist()/500
            ...
            for i in range(500):
                ...
                rtde_c.servoL(tcp_pose, 0, 0, time_b/500 , 0.1, 500)
                tcp_pose += move_p_final.tolist()/500
    ...
    def string_crossing(start_bow_poses, end_bow_poses, next_dir):
        ...
        for i in range(500):
            ...
            rtde_c.servoL(tcp_pose, 0, 0, 1/500 , 0.1, 500)
            tcp_pose += final_target.tolist()/500
    ...
    def run_performance(midi_path):
        notes = robot_runner_rtde.parse_midi(midi_path)
